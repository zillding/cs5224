...
.on('end', function(){
  ...
  outputStream.write(JSON.stringify(result, null, 2), err => {
...
// start processing
outputStream.write('// This file is generated by /scripts/parseCSV.js\n')
outputStream.write('// Please do not mannually modify\n')
